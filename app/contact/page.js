            ...
            <div className="col-12 col-lg-6">
              <div className="row justify-content-xl-center">
                <div className="col-12 col-xl-11">
                  <h2 className="h1 mb-3">ติดต่อเรา</h2>
                  <p className="lead fs-4 text-secondary mb-5"></p>
                  <div className="d-flex mb-5">
                    <div className="me-4 text-primary">
                      <svg xmlns="logo.jpg" width="32" height="32" fill="currentColor" className="bi bi-geo" viewBox="0 0 16 16">
                    ...
                    <div>
                      ...
                      <address className="mb-0 text-secondary">88/888/88ppoop</address>
                    </div>
                  </div>
                  <div className="row mb-5">
                    ...
                    <div className="col-12 col-sm-6">
                      <div className="d-flex mb-0">
                        <div className="me-4 text-primary">
                        <img src="img/logo.jpg" alt="Logo" width="45" height="45" className="d-inline-block align-text-top" />
                        </div>
                        <div>
                          <h4 className="mb-3">Email</h4>
                          <p className="mb-0">
                            <a className="link-secondary text-decoration-none" href="mailto:contact@bootbrains.com">soccershop@gmail.com</a>
                          </p>
                        </div>
                      </div>
                    </div>
